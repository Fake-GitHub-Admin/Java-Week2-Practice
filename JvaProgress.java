...
public class JvaProgress {
   ...
   static void bothLists() 
      {
         System.out.println("Java Code Progress as of 3/28/2022");
   ...
   static void theList(String name, String gender, int age, String YesOrNoForCriminal) 
   {
      if (YesOrNoForCriminal == "Y")
      {
         ...
         System.out.println("Suspect " + name + " " + gender + " " + age + " tested Positive on test for Criminals");
      }
      else if (YesOrNoForCriminal == "N")
      {
         System.out.println("Suspect " + name + " " + gender + " " + age + " tested Negative on test for Criminals");
      }
      else 
      {
